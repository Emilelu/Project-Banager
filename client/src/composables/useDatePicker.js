...
// 校验日期格式是否合规
// 支持: YYYY, YYYY/MM, YYYY/MM/DD, YYYY/MM/DD HH:mm, YYYY/MM/DD HH:mm:ss, YYYY~YYYY
...
// 从 watch_date 提取所有相关年份（用于年份范围匹配）
// 2014~2017 返回 ['2014','2015','2016','2017']
...
// 将 type="date" 的值 (YYYY-MM-DD) 转为 YYYY/MM/DD
export function dateInputToFormat(dateValue) {
  if (!dateValue) return ''
  return String(dateValue).replace(/-/g, '/')
}

// 将 YYYY/MM/DD 转为 type="date" 需要的 YYYY-MM-DD
